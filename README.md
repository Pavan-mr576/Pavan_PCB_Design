This GitHub project contains the design files for a PCB built around a 555 timer chip. You'll find the circuit schematic and the layout for the actual board, both created in Altium Designer.
